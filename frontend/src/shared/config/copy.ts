export const COPY = {
  ...
  PROFILE: {
    ...
    ERROR_PROFILE_TITLE: "Error Profile",
    ERROR_PROFILE_DESCRIPTION:
      "Track recurring error patterns and the topics where they appear most.",
    ERROR_PROFILE_EMPTY:
      "Submit more solutions to start tracking your error patterns.",
    ERROR_PROFILE_RECENT: "Recent Errors",
    ERROR_PROFILE_ALL_TIME: "All-Time Errors",
    ERROR_PROFILE_ACTIVE_LABELS: "Error Categories",
    ERROR_PROFILE_ACTIVE_TOPICS: "Affected Topics",
    ERROR_PROFILE_WINDOW: "Analysis Window",
    ERROR_PROFILE_TOP_LABELS: "Top Error Categories",
    ERROR_PROFILE_TOP_TOPICS: "Most Affected Topics",
    ERROR_PROFILE_SHARE: "Recent Share",
    ERROR_PROFILE_RECENT_COUNT: "Recent",
    ERROR_PROFILE_ALL_TIME_COUNT: "All-Time",
    ERROR_PROFILE_TOPICS: "Related Topics",
    ERROR_PROFILE_LABELS: "Error Breakdown",
    ERROR_PROFILE_SIGNAL: "Overview",
    ERROR_PROFILE_DISTRIBUTION: "Error Distribution",
    ERROR_PROFILE_DISTRIBUTION_DESC:
      "Dark segment shows errors in the recent window, light segment shows all-time total.",
    ERROR_PROFILE_RECENT_HINT: `Last {days} days`,
    ERROR_PROFILE_ALL_TIME_HINT: "Profiled failed submissions",
    ERROR_PROFILE_ACTIVE_LABELS_HINT: "Distinct error categories encountered",
    ERROR_PROFILE_ACTIVE_TOPICS_HINT: "Topics with recorded errors",
    ERROR_PROFILE_COUNTS: "{recent} recent · {total} all-time",
